//package com.DemoWebShopapp.pages;
	...
	//package com.DemoWebShopapp.pages;
		...
		public class JewelryPage extends BasePage
		{
			...
			public final HyperLink link = new HyperLink("Black&whitediamondheart", By.xpath("(//h2[@class='product-title'])[2]"));
			public final Element BlackandWhiteDiamond=new Element("black&whitediamondheartpage",By.xpath("//strong[text()='Black & White Diamond Heart']"));
			public final TextBox qty=new TextBox("Qty", By.id("addtocart_14_EnteredQuantity"));
		    public final Element cartpop=new Element("popupmsg",By.xpath("//p[text()='The product has been added to your ']"));
		    ...
		    //public final CheckBox termsandcond=new CheckBox("Termscondtions",By.id("termsofservice"));
		    public final Button checkout=new Button("CheckOut",By.id("checkout"));
		    //public final Element CheckoutText=new Element("Checkoutpage",By.xpath("//h1[text()='Checkout']"));
