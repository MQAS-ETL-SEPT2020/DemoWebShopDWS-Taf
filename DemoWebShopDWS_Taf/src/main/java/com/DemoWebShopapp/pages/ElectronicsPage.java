...
public class ElectronicsPage extends BasePage {
	...
	public final HyperLink cellphones=new HyperLink("cellphones link", By.xpath("//a[@href='/cell-phones'][@title='Show products in category Cell phones'][contains(text(),'Cell phones')]"));
	public final HyperLink Smartphone = new HyperLink("Smartphone link", By.xpath("//a[text()='Smartphone']"));
	...
	public final Button CheckOut = new Button("CheckOut Button", By.xpath("//button['checkout']"));
